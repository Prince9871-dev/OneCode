...
const TemplateSelectionModal = ({
    ...
    const filteredTemplates = templates.filter((template) => {
        const matchesSearch = template.name.toLowerCase().includes(searchQuery.toLocaleLowerCase()) ||
            template.description.toLowerCase().includes(searchQuery.toLocaleLowerCase()) ||
