...
import { createPlaygroundForUser } from "../actions";
...
const AddNewButton = () => {
    ...
    const [selectedTemplate, setSelectedTemplate] = useState<{title:string; 
    ...
    const handleSubmit = async (data: {title:string; 
        ...
        const res = await createPlaygroundForUser(data);
